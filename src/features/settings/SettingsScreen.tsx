...
export function SettingsScreen() {
  ...
  return (
    <ScreenPlaceholder eyebrow="Preferences" title="Settings" description="Manage tracking, backups, and how Trace works for you.">
      <section className="sync-card" aria-labelledby="google-backup-heading">
        <div className="sync-card__heading"><span aria-hidden="true">☁</span><div><p className="developer-card__label">Data &amp; backup</p><h2 id="google-backup-heading">Google Sheets backup</h2><p>Keep an accessible copy of your Trace data in your own Google Sheet.</p></div></div>
        {!connection ? (
          <>
